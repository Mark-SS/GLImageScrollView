#
#  Be sure to run `pod spec lint GLImageScrolView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of GLImageScrolView in Markdown format.
  ...
  # Or just: s.author    = "markss"
  # s.authors            = { "markss" => "glqdcs@163.com" }
  # s.social_media_url   = ""
